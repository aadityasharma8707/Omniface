...
export default function LandingPage() {
  ...
  const scrollToSection = useCallback((id: string) => {
    ...
    if (id === 'problem-section' || id === 'problem-content' || id === 'problem' || id.includes('problem')) {
      const targetScroll = Math.round(vh * 2.2);
      window.scrollTo({ top: targetScroll, behavior: 'smooth' });

      // Reset any inner container scroll so the top of ProblemSection is visible
      const problemLayer = document.getElementById('problem-stage-layer');
      if (problemLayer) {
        problemLayer.scrollTo({ top: 0, behavior: 'smooth' });
      }
      return;
    }
  ...
  return (
    ...
    >
      ...
      */}
      ...
      {/* 
        ...
        2. PERSISTENT GLOBAL ROBOTIC FACE BACKGROUND LAYER
           - Preloads 150-frame optimized JPG sequence
      ...
      */}
      ...
      {/* 
        =============================================================================
        3. GLOBAL FIXED TOP NAVIGATION BAR
        =============================================================================
      */}
      <HeroNav onScrollTo={scrollToSection} />
