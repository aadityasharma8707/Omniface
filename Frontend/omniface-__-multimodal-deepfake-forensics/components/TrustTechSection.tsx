    ...
    <section className="page-section" id="trust-tech-section" style={{ position: 'relative', zIndex: 10 }}>
      ...
      >
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <p style={{ fontSize: '13.5px', color: 'rgba(255, 255, 255, 0.72)', lineHeight: 1.5, marginLeft: 'clamp(0px, 3.5vw, 38px)', marginBottom: '16px' }}>
        ...
        >
          ...
          <p
            style={{
              ...
              fontWeight: 500,
              lineHeight: 1.6,
              marginLeft: 'clamp(0px, 3.5vw, 42px)',
              maxWidth: '750px',
            }}
          >
      ...
      >
        ...
        <div className="forensic-card" id="tech-pillar-robust-eval" style={{ padding: 'clamp(18px, 2.5vh, 24px)' }}>
          ...
          <p style={{ fontSize: '13px', lineHeight: 1.6, color: 'rgba(255, 255, 255, 0.75)', marginLeft: 'clamp(0px, 3.5vw, 38px)' }}>
