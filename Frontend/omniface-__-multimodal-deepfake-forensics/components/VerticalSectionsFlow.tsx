    ...
    >
      ...
      <div
        ...
        style={{
          width: '100%',
          maxWidth: '100%',
          padding: 'clamp(60px, 9vh, 110px) clamp(14px, 3.5vw, 56px)',
      ...
      <div
        ...
        style={{
          width: '100%',
          maxWidth: '100%',
          padding: 'clamp(60px, 9vh, 110px) clamp(14px, 3.5vw, 56px) 0 clamp(14px, 3.5vw, 56px)',
          boxSizing: 'border-box',
          position: 'relative',
        }}
      >
      ...
      <div
        ...
        style={{
          width: '100%',
          maxWidth: '100%',
          padding: '0 clamp(14px, 3.5vw, 56px) clamp(40px, 6vh, 64px) clamp(14px, 3.5vw, 56px)',
          boxSizing: 'border-box',
          position: 'relative',
        }}
      >
